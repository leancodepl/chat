...
public class Conversation
{
    ...
    public Message WriteMessage(Guid guid, Guid senderId, string? content, List<Attachment>? attachments)
    {
        return Message.Create(guid, Id, senderId, NextMessageCounter, content, attachments);
    }
}
