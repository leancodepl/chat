...
{
    public static IEnumerable<Guid> GetMemberIdsForIncrementOnNewMessage(Conversation conversation, Message newMessage)
    {
        return conversation
    ...
    public static IEnumerable<Guid> GetMemberIdsForDecrementOnNewMessage(Conversation conversation, Message newMessage)
    {
