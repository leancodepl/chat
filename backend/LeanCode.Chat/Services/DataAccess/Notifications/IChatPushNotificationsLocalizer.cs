...
{
    public Task<Dictionary<Guid, CultureInfo>> GetUserLocales(List<Guid> userIds);
    public Task<Dictionary<CultureInfo, Notification>> LocalizeNewMessageNotification(
